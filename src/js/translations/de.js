...
module.exports = {
  translation: {
    ...
    'config.general.description': 'Allgemeine Einstellungen',
    'config.general.title': 'Allgemein',
    'config.general/header.title': 'Dime personalisieren',
    'config.general/header/icon.title': 'Anwendungssymbol',
    'config.general/header/name.title': 'Name der Anwendung',
    'config.general/header/color.description': 'Farbe der Kopfleiste ändern (z.b. "red" für rot)',
    'config.general/header/color.title': 'Farbe der Anwendung',
    'config.prompt.title': 'Befehlszeile',
    'config.prompt/shortcuts.title': 'Tastenkürzel für Eingabezeilen',
    'config.prompt/shortcuts/focusFilter.title': 'Filter fokussieren',
    'config.prompt/shortcuts/focusPrompt.title': 'Befehlszeile fokussieren',
    'config.prompt/shortcuts/submitPrompt.title': 'Befehlszeile absenden',
    'config.prompt/shortcuts/blurPrompt.title': 'Befehlszeile verlassen',
    'config.prompt/shortcuts/triggerAutocompletion.title': 'Autovervollständigung aktivieren',
    'config.prompt/shortcuts/cycleSuggestionsLeft.title': 'springe zum vorherigen Ergebnis der Autovervollständigung wechseln',
    'config.prompt/shortcuts/cycleSuggestionsRight.title': 'springe zum nächsten Ergebnis der Autovervollständigung wechseln',
